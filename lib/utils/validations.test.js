      ...
      describe('ContentBasedDeduplication', () => {
        test('throw error when ContentBasedDeduplication is wrong type', () => {
          expect(() =>
            ...
            'At path: Attributes.ContentBasedDeduplication -- Expected a value of type `boolean`, but received: `"foo"`'
          );
        });
      ...
      describe('FifoQueue', () => {
        test('throw error when FifoQueue is wrong type', () => {
          expect(() =>
            ...
            'At path: Attributes.FifoQueue -- Expected a value of type `boolean`, but received: `"foo"`'
          );
        });
