...
const { Message, Queue } = require('./validations');
    ...
    describe('Attributes', () => {
      ...
      describe('KmsMasterKeyId', () => {
        test('throw error when KmsMasterKeyId is wrong type', () => {
          expect(() =>
            Queue({ Attributes: { KmsMasterKeyId: true }, QueueName: 'foo-bar' })
          ).toThrow(
      ...
      describe('MessageRetentionPeriod', () => {
        ...
        test('create queue with custom MessageRetentionPeriod', () => {
          expect(
            Queue({ Attributes: { MessageRetentionPeriod: 70 }, QueueName: 'foo-bar' })
          ).toEqual({
            Attributes: {
              DelaySeconds: 0,
              FifoQueue: false,
  ...
  describe('Message', () => {
    describe('DelaySeconds', () => {
      ...
      test('throw error when DelaySeconds is less than allowed', () => {
        ...
        expect(() => Message(params)).toThrow('Invalid value for the parameter DelaySeconds.');
      });
