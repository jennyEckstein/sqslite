    ...
    describe('Attributes', () => {
      describe('ContentBasedDeduplication', () => {
        test('throw error when ContentBasedDeduplication is wrong type', () => {
          expect(() =>
            ...
            'At path: Attributes.ContentBasedDeduplication -- Expected a value of type `boolean` for `Attributes.ContentBasedDeduplication`, but received: `"foo"`'
          );
        });
      ...
      describe('FifoQueue', () => {
        test('throw error when FifoQueue is wrong type', () => {
          expect(() =>
            ...
            'At path: Attributes.FifoQueue -- Expected a value of type `boolean` for `Attributes.FifoQueue`, but received: `"foo"`'
          );
        });
      ...
      describe('KmsMasterKeyId', () => {
        test('throw error when KmsMasterKeyId is wrong type', () => {
          ...
          ).toThrow('At path: Attributes.KmsMasterKeyId -- Expected a string, but received: true');
        });
    ...
    describe('Tags', () => {
      test('throw error when tags is invalid type', () => {
        expect(() => assertQueue({ QueueName: 'foo-bar', tags: 'foo' })).toThrow(
          'At path: tags -- Expected an object, but received: "foo"'
        );
      });
