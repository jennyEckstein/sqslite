...
// TODO: message-system-attributes fors not work
module.exports = opts => {
  const app = fastify({
    logger: true,
    ...opts
  ...
  // app.post('/queues/:queueName', async (request, reply) => {
  //   const { body } = request;
  ...
  //     switch (body && body.Action) {
  //       case 'SendMessage':
  //         return sendMessage(body, queueName);
  //       default:
  //         return `Action: ${body.Action} is not implemented`;
  //     }
  //   } catch (err) {
