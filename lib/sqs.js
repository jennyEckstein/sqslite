 ...
 * @returns {QueueObject} - The requested queue.
 */
 ...
 * @param {string} params.ReceiptHandle - The message receipt handle.
 * @throws AWS.SimpleQueueService.NonExistentQueue, thrown if queue does not exist.
 */
...
/**
 * Deletes messages in a batch from the specified queue.
 *
...
/**
 * Adds tag to specified queue.
 *
 * @param {string} QueueUrl - The url for the queue to add tags to.
 * @param {Map<string,string>} tags - Tags to add.
 * @returns {void}
 */
...
/**
 * Adds attributes to specified queue.
 *
 * @param {string} QueueUrl - The url for the queue to add attributes to.
 * @param {QueueAttributes} Attributes - The queue attributes to set.
 * @returns {void}
 * @throws AWS.SimpleQueueService.NonExistentQueue, thrown if queue does not exist.
 */
...
/**
 * Retrieves attributes from the specified queue.
 *
 * @param {string} QueueUrl - The url for the queue to remove tags from.
 * @param {Array<string>} Attributes - The name of attributes to retrieve information from.
 * @returns {QueueAttributes} - Returns attribute object.
 * @throws AWS.SimpleQueueService.NonExistentQueue, thrown if queue does not exist.
 */
...
/**
 * Retrieves all queues with the RedrivePolicy attribute set to a dead letter queue.
 *
 ...
 * @param {string} params.ReceiptHandle - The message receipt handle.
 * @param {number} params.VisibilityTimeout - The new visibility time out value.
 * @returns {void}
 * @throws AWS.SimpleQueueService.NonExistentQueue, thrown if queue does not exist for specific wsdl version.
 ...
 * @property {QueueAttributes} Attributes - The queue attributes.
 * @property {Array<MessageObject>} messages - Messages in the queue.
 ...
 * @property {string} Attributes - The queue attributes.
 ...
 * @property {Array<MessageObject>} messages - The messages to send in the same format, with individual messages in the same format as SendMessageParams
 * @property {string} QueueUrl - The url for the queue.
 */
 ...
 * @property {Object} Attributes - The attributes for the queue.
 * @property {string} Body - The body of the message.
 * @property {string|number[]} MD5OfBody - MD5 of the body of the message.
