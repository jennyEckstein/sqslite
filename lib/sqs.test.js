...
const { clearQueues } = require('./sqs').debug;
...
describe('sqs', () => {
  describe('createQueue', () => {
    ...
    test('throw an error when queue name is too long', () => {
      ...
      expect(error.xml).toEqualXML(expectedResponse);
    });
  ...
  describe('listQueues', () => {
    ...
    test('list all queues when list has queues', () => {
      ...
      const expectedResponse = `<ListQueuesResponse xmlns="http://queue.amazonaws.com/doc/2012-11-05/">
      <ListQueuesResult><QueueUrl>https://queue.amazonaws.com/123/foo-bar1</QueueUrl>,<QueueUrl>https://queue.amazonaws.com/123/foo-bar2</QueueUrl></ListQueuesResult>
      <ResponseMetadata>
        <RequestId>00000000-0000-0000-0000-000000000000</RequestId>
      </ResponseMetadata>
    </ListQueuesResponse>`;
