...
describe('lib/index', () => {
  ...
  // TODO: something is off with MessageAttributes
  ...
  // describe('purgeQueue', () => {
  //   test.only('successfully purge queue', async () => {
  //     const command = new CreateQueueCommand({ QueueName: 'core-test' });
  //     console.log('command:', command);

  //     const res = await client.send(command);
  //     console.log('res:', res);

  //     // await client.createQueue({ QueueName: 'core-test' });
  //     await client.sendMessage({ MessageBody: 'foo' }).promise();
  //     await expect(
