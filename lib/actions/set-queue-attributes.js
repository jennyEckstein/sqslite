...
/**
 * Action Handler for setting attributes for the queue.
 *
 * @param {{
 *  QueueUrl: string,
 ...
 * }} body - Request body.
 * @returns {string} XMLSetQueueAttributesResponse.
 * @throws XMLErrors, based on setQueueAttributes's errors.
 *
