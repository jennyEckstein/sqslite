...
/**
 * Action Handler for deleting batch messages.
 *
 * @param {{
 *  QueueUrl: string,
 *  "DeleteMessageBatchRequestEntry.i.Id": string,
 *  "DeleteMessageBatchRequestEntry.i.ReceiptHandle": string
 * }} body - Request body.
 * @returns {string} XMLDeleteMessageBatchResponse.
 * @throws XMLErrors, based on deleteMessageBatch's errors.
 *
 * @example Request body
 *
 * {
 *   QueueUrl: "queueUrl",
 *   "DeleteMessageBatchRequestEntry.1.Id": "123",
